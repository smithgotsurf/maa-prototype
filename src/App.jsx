...
.pg{max-width:900px;margin:0 auto;padding:28px 20px}.pgn{max-width:680px;margin:0 auto}
.hero{background:linear-gradient(rgba(0,0,0,.55),rgba(0,0,0,.68)),url('${B_URL}static/home-top-background.jpg') center/cover no-repeat;color:#fff;padding:64px 28px 180px;text-align:center;position:relative;overflow:hidden}
...
.sb{background:#fff;border:1px solid ${C.bdrLt};border-radius:12px;padding:20px 24px;margin:-136px auto 24px;max-width:600px;position:relative;z-index:10;box-shadow:0 3px 20px rgba(0,0,0,.05);display:flex;align-items:center;justify-content:space-between}
...
.pcol-h{font-size:11px;color:${C.gray};text-transform:uppercase;letter-spacing:.7px;font-weight:600;padding:0 2px}
...
.wv{border:1px solid ${C.goldDk};border-radius:9px;padding:16px;margin-bottom:9px}
...
.bcrd{background:#fff;border:1px solid ${C.goldDk};border-radius:9px;padding:18px;text-align:center}
...
.spt{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-top:14px}
...
@media(max-width:768px){.hero h1{font-size:28px}.sts{grid-template-columns:repeat(2,1fr)}.adm{grid-template-columns:1fr}.asd{display:none}.pgrid{grid-template-columns:1fr}.sb{flex-direction:column;gap:8px;text-align:center}.st span{display:none}.bgrd{grid-template-columns:1fr}.spt{grid-template-columns:1fr}.H-full{display:none}.ic-grid{grid-template-columns:1fr}}`;
